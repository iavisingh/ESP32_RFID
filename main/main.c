...
//#define BROKER "mqtt://thingsboard.cloud:1883"
#define BROKER "mqtt://demo.thingsboard.io:1883"

//#define BROKER "mqtt://52.87.177.173:1883"
//#define BROKER  "mqtt://mqtt.broker.io:1883"
//#define USERNAME "avi9761"
//#define DEVICE_CRED "Avisingh1@$"
//#define DEVICE_ID "RFID"
//#define TOPIC "CDAC/ACTS/DESD"
//#define TOPIC "v2/avi9761/buckets/RFID/CDAC/ACTS/DESD"
#define TOPIC "v1/devices/me/attributes"
//#define ACCESS_TOKEN "2Faz5EMj1UM0iaknvUug"
#define ACCESS_TOKEN "device111"
#define SSID "FS-1578"
//#define SSID "acts"
...
static void rc522_handler(void* arg, esp_event_base_t base, int32_t event_id, void* event_data)
{
    ...
    switch(event_id) {
        case RC522_EVENT_TAG_SCANNED: {
                ...
                sprintf(message, "{\"STUDENT\":\"%llu\"}", tag->serial_number);
